  ...
  return (
    <div >
      <Card className="w-full bg-zinc-900 border-zinc-800">
        <CardHeader>
          <CardTitle className="text-zinc-50 text-2xl">Send Anonymous Email</CardTitle>
          <CardDescription className="text-zinc-400">Please do not abuse this service</CardDescription>
        </CardHeader>
